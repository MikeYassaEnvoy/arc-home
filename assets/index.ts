...
/** All badge art. Keys are the canonical badge ids awarded by the ceremonies. */
export const badges = {
  'arcade-ace': new URL('./badges/arcade-ace.svg', import.meta.url).href,
  'backyard-explorer': new URL('./badges/backyard-explorer.svg', import.meta.url).href,
  'brave-bite': new URL('./badges/brave-bite.svg', import.meta.url).href,
  ...
  'kitchen-captain': new URL('./badges/kitchen-captain.svg', import.meta.url).href,
  ...
  'sock-ninja': new URL('./badges/sock-ninja.svg', import.meta.url).href,
} as const;
...
/** Room stickers earned at each pit stop and dropped onto the house map. */
export const stickers = {
  'home': new URL('./map/sticker-home.svg', import.meta.url).href,
  'kitchen': new URL('./map/sticker-kitchen.svg', import.meta.url).href,
  'backyard': new URL('./map/sticker-backyard.svg', import.meta.url).href,
  'sock': new URL('./map/sticker-sock.svg', import.meta.url).href,
  'couch': new URL('./map/sticker-couch.svg', import.meta.url).href,
  'trophy': new URL('./map/sticker-trophy.svg', import.meta.url).href,
} as const;
...
/**
 * route-map.svg exposes one `#segment-N` and one `#node-N` per leg (N = 0…5).
 ...
 * node — drop a room sticker in there when the leg is completed.
 */
...
/** Which room sticker a leg unlocks (leg id -> sticker key). */
