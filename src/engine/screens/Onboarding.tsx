    ...
    <div className="screen onboarding">
      <div className="onboarding__inner">
        <header className="onboarding__head">
          <p className="kicker">The Amazing Race</p>
          <h1 className="h1 h1--mega">HOME EDITION</h1>
          <p className="lead">Welcome back, champions! Two questions before the rematch.</p>
        </header>
