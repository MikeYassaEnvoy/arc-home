...
export default function FinaleSequence({
  ...
  const finalEntry: ScriptEntry | undefined = entries[entries.length - 1];
    ...
    <div className="arc-scene arc-finale">
      ...
      {phase === 'photofinish' && (
        <div className="arc-finale-stage arc-photofinish">
          <span className="arc-eyebrow">Leg {finalEntry?.legId ?? 5} · The Finish Line</span>
      ...
      {phase === 'win' && (
        <div className="arc-finale-stage">
          ...
          <p className="arc-finale-sub">
            {teamName} — champions of The Amazing Race: Home Edition
          </p>
      ...
      {phase === 'trophy' && (
        <div className="arc-finale-stage arc-trophy-stage">
          ...
          <p className="arc-trophy-sub">Winners of The Amazing Race: Home Edition</p>
